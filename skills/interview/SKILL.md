...
- **Explore the codebase** before asking about anything that could be answered by reading the code. Invoke the built-in `Explore` agent (subagent_type: Explore) to map the codebase. Do not ask the human what already exists — find it yourself.
